...
<div id="view_entry_nav">
  ...
  if (!$keep_private && !$enable_periods)
  {
    ...
    if (!$series)
    {
      //echo "<a href=\"view_entry.php?action=export&amp;id=$id&amp;returl=$link_returl\">". get_vocab("exportentry") ."</a> <br>";
     // echo "<a href=\"view_entry.php?action=export&amp;id=$id&amp;returl=$link_returl\">". get_vocab("exportentrypdf") ."</a>";
      echo"<form action=\"\" method=\"get\">

            <input type=\"button\" name=\"imprimir\" value=\"Imprimir\"  onClick=\"printdiv('entry'); \"/>
            </form>";
    } 
    if (!empty($repeat_id)  && !$series)
    {
